...
public:
    ...
    enum EventType
    {
        ...
        MouseMotion,			///< The mouse cursor moved RAW input (data in event.mouseMove)
    ...
    union
    {
        ...
        MouseMotionEvent      mouseMotion;	  ///< Mouse move event parameters RAW input (Event::MouseMotion)
